...
// can't mix BigInt and other types, must use explicit conversion
console.log(3 + 4 + Number(1n));
...
// ?? only checks for null or undefined, will return false and other falsey values
// || counts falsey values, wont return it first
...
console.log('' ?? 'hi'); // empty string returned
console.log('' || 'hi'); // 'hi' string returned
